...
/**
 * UsesContent component displays the material shown on the uses page.
 */
            ...
            <List>
              <List.Item>
                ...
                <List.Content>
                  ...
                  <List.Description>
                    ...
                    Sublime, and Atom. However, the number of extensions and debug tools
                    VS Code provides propels it to be the winner for me.
                  </List.Description>
                </List.Content>
              </List.Item>
              ...
              <List.Item>
                ...
                <List.Content>
                  ...
                  <List.Description>
                    With the power of workflows, Alfred makes my life easy. I also use it
                    as a replacement for the Mac Spotlight.
                  </List.Description>
                </List.Content>
              </List.Item>
              ...
              <List.Item>
                ...
                <List.Content>
                  ...
                  <List.Description>
                    With 4k resolution IPS - LED, this monitor satisfies pretty much all
                    of my requirements for a desktop monitor. I highly recommend it.
                  </List.Description>
                </List.Content>
              </List.Item>
              ...
              <List.Item>
                ...
                <List.Content>
                  ...
                  <List.Description>
                    ...
                    and this keyboard has a nifty feature where you can utilize one
                    keyboard to toggle between various devices. The keyboard feel is kind
                    of stiff, in my opinion, but I feel like the multi-device
                    functionality outweighs any con.
                  </List.Description>
                </List.Content>
              </List.Item>
              ...
              <List.Item>
                ...
                <List.Content>
                  ...
                  <List.Description>
                    This mouse has a similar functionality as my wireless keyboard where
                    it can connect and toggle between multiple devices. As you can see,
                    I'm all about the devices that can handle multiple devices.
                  </List.Description>
                </List.Content>
              </List.Item>
              ...
              <List.Item>
                ...
                <List.Content>
                  ...
                  <List.Description>
                    ...
                    Elgato docking station that centralizes all of my devices and I
                    couldn't be happier.
                  </List.Description>
                </List.Content>
              </List.Item>
